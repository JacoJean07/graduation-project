<%-- 
    Document   : header
    Created on : 14 may. 2024, 13:50:56
    Author     : Jaco
--%>
...
<footer class="footer">
    <div class="container-fluid">
        <div class="copyright float-right">
            ...
            <a href="#" target="_blank">Bella Cosmetica</a>.
        </div>
    </div>
</footer>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="frmPass">
                    ...
                    <button class="btn btn-info btn-block" type="button" onclick="btnCambiar(event)">Cambiar</button>
                </form>
            </div>
        </div>
    </div>
