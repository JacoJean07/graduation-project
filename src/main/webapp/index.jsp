    ...
    <section class="ftco-section p-5">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 border rounded shadow" style="background-color: #feccf536;">
                    <div class="login-wrap p-5">
                        <h1 class="text-center mb-0 text-white">Bienvenido</h1>
                        <p class="text-center text-white lead">Inicio de sesion de Bella Cosmetica</p>
                        <form action="AuthController" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" class="btn form-control btn-dark rounded submit px-3">Iniciar Sesion</button>
                                <!-- <a href="main/index.jsp" class="btn form-control btn-dark rounded submit px-3">Iniciar Sesion</a> -->
